...
<body class="g-sidenav-show  bg-gray-200">
  ...
  ?>
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-white  active bg-gradient-primary" href="lichhen.php">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Lịch hẹn</h6>
                </div>
              </div>
              <?php
              //  message
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Người hẹn</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ngày đăng ký</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Giờ đăng ký</th>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Hủy</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Xác nhận</th>
                        <th class="text-secondary opacity-7"></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      $query = "SELECT * FROM lichtuvan INNER JOIN nhanvien on lichtuvan.NV_ID=nhanvien.NV_ID INNER JOIN nguoidung on lichtuvan.ND_ID=nguoidung.ND_ID";
                      ...
                      ?>
                          <tr>
                            ...
                            <td><?php echo $row['L_NGAYDANGKY']; ?></td>
                            <td><?php echo $row['L_GIODANGKY']; ?></td>
                            <td><?php echo $row['L_GHICHU']; ?></td>
                            <td>
                              <?php
                              if ($row['L_TRANGTHAI'] == '2') {
                                echo 'Đang chờ xác nhận';
                              } elseif ($row['L_TRANGTHAI'] == '1') {
                                echo 'Đã xác nhận';
                              } elseif ($row['L_TRANGTHAI'] == '0') {
                                echo 'Đã hủy';
                              }
                              ?>
                            </td>
                            <td><?php echo $row['created_at']; ?></td>
                            <td><a href='huyl.php?id_l=<?php echo $row['L_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>Hủy</label></a></td>
                            <td><a href='xacnhanl.php?id_l=<?php echo $row['L_ID'] ?>'><label class=' badge badge-sm bg-gradient-success'>Xác nhận</label></a></td>
                            <td><a href='sualh.php?id_l=<?php echo $row['L_ID'] ?>'><label class=' badge badge-sm bg-gradient-warning'>Sửa</label></a></td>
                          </tr>
                        <?php
                        }
                      } else {
    ...
    <script>
      function Del(name) {
        return confirm("Bạn muốn xóa tin: " + name + "?");
      }
    </script>
