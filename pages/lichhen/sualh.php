            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Sửa lịch hẹn</h6>
                    </div>
                </div>
                <br>
                <?php               
                ...
                //
                $sql_nv = "SELECT* FROM nhanvien where NV_QUYENSD=1";
                $query_nv = mysqli_query($con, $sql_nv);


                ///////////////////////
                $sql_up = "SELECT * FROM lichtuvan where L_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {                    
                    ...
                    $sql_sua="UPDATE `lichtuvan` SET `NV_ID`='$nn',`ND_ID`='$nh',`L_NGAYDANGKY`='$n',`L_GIODANGKY`='$g',`L_TRANGTHAI`='$tt',`L_GHICHU`='$gc' WHERE L_ID= $id";
                    ...
                    <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <select class="form-control" name="nguoinhan">
                                    ...
                                    <?php
                                    while ($row_nv = mysqli_fetch_assoc($query_nv)) { ?>
                                        <option value="<?php echo $row_nv['NV_ID']; ?>"><?php echo $row_nv['NV_HOTEN']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <select class="form-control" name="nguoihen">

                                    <?php
                                    while ($row_nd = mysqli_fetch_assoc($query_nd)) { ?>
                                        <option value="<?php echo $row_nd['ND_ID']; ?>"><?php echo $row_nd['ND_HOVATEN']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="date" name="ngay" class="form-control" value="<?php echo $row_up['L_NGAYDANGKY']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Giờ đăng ký</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="gio" class="form-control" value="<?php echo $row_up['L_GIODANGKY']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Trạng thái</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="trangthai" class="form-control" value="<?php echo $row_up['L_TRANGTHAI']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ghichu" class="form-control" value="<?php echo $row_up['L_GHICHU']; ?>" required placeholder="">
                            </div>
                        </div>
