    ...
    ?>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-4">
                ...
                $sql_up = "SELECT * FROM duoc where D_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_sua="UPDATE `duoc` SET `LD_ID`='$lt',`D_HINHANH`='$a',`D_TENDUOC`='$t',`D_THONGTINCHITIET`='$ct',`D_GHICHU`='$gc' WHERE D_ID= $id";
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" name="anh" class="form-control-file" value="<?php echo $row_up['D_HINHANH']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Tên thuốc</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ten" class="form-control" value="<?php echo $row_up['D_TENDUOC']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Thông tin chi tiết</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="chitiet" class="form-control" value="<?php echo $row_up['D_THONGTINCHITIET']; ?>" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ghichu" class="form-control" value="<?php echo $row_up['D_GHICHU']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
