    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-white  active bg-gradient-primary" href="duoc.php">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3" style="text-align: center;">THUỐC</h6>
                </div>
              </div>
              <?php
              //  message
              ...
              <div style="align-self:center ;">
                <td><a href='themd.php'><button class='btn btn-dark'>Thêm</button></a></td>
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tên thuốc</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thông tn chi tiết</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ghi chú</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Loại thuốc</th>
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT * FROM duoc INNER JOIN loaiduoc on duoc.LD_ID=loaiduoc.LD_ID";
                      $query_run = mysqli_query($con, $query);
                      if (mysqli_num_rows($query_run) > 0) {
                        foreach ($query_run as $row) {
                      ?>
                          <tr>
                            <td><a href='suad.php?id_d=<?php echo $row['D_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Sửa</label></a></td>
                            <td><a onclick="return Del('<?php echo $row['D_TENDUOC']; ?>')" href='xoad.php?id_d=<?php echo $row['D_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>Xóa</label></a></td>
                            <td><?php echo $row['D_ID']; ?></td>
                            <td>
                              <img style="width:50px; border-radius: 50%; height:50px;" src="../../image/duoc/<?php echo $row['D_HINHANH']; ?>">
                            </td>
                            <td><?php echo $row['D_TENDUOC']; ?></td>
                            <td><?php echo $row['D_THONGTINCHITIET']; ?></td>
                            <td><?php echo $row['D_GHICHU']; ?></td>
                            <td><?php echo $row['LD_TENLOAI']; ?></td>
