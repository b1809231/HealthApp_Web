            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm thuốc</h6>
                    </div>
                </div>

                <br>
                <?php
                $sql_ld = "SELECT *FROM loaiduoc";
                $query_ld = mysqli_query($con, $sql_ld);
                if (isset($_POST['submit'])) {
                    ...
                    $sql_them = "INSERT INTO duoc (D_HINHANH,D_TENDUOC,D_THONGTINCHITIET,D_GHICHU,LD_ID) VALUES ('$a','$t','$ct','$gc','$lt') ";
                    $query = mysqli_query($con, $sql_them);
                    move_uploaded_file($a_tmp, '../../image/duoc/' . $a);
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="chitiet" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ghichu" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <select class="form-control" name="loaithuoc">
                                    ...
                                    <?php
                                    while ($row_ld = mysqli_fetch_assoc($query_ld)) { ?>
                                        <option value="<?php echo $row_ld['LD_ID']; ?>"><?php echo $row_ld['LD_TENLOAI']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
