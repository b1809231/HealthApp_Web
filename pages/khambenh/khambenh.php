                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Lịch sử khám bệnh</h6>
                                </div>
                            </div>
                            <?php
                            //  message
                            ...
                            <div style="align-self:center ;">
                                <td><a href='themls.php'><button class='btn btn-dark'>Thêm</button></a></td>
                                <td><a href='ls.php'><button class='btn btn-dark'>In</button></a></td>
                            </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tên người bệnh</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Chuẩn đoán</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thuốc uống</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nhắc nhở</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ngày khám</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM khambenh INNER JOIN nguoidung on khambenh.ND_ID=nguoidung.ND_ID";
                                            $query_run = mysqli_query($con, $query);
                                            if (mysqli_num_rows($query_run) > 0) {
                                                foreach ($query_run as $row) {
                                            ?>
                                                    <tr>                                                    
                                                        <td><a href='suakb.php?id_ls=<?php echo $row['KB_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Sửa</label></a></td>
                                                        <td><?php echo $row['KB_ID']; ?></td>
                                                        <td><?php echo $row['ND_HOVATEN']; ?></td>
                                                        <td><?php echo $row['KB_CHUANDOAN']; ?></td>
                                                        <td><?php echo $row['KB_THUOCUONG']; ?></td>
                                                        <td><?php echo $row['KB_NHACNHO']; ?></td>
                                                        <td><?php echo $row['KB_NGAYKHAM']; ?></td>
                                                    </tr>
                                                <?php
                                                }
                                            } else {
