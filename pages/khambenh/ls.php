                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td><a href='in.php?id_nd=<?php echo $row['ND_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>In khám bệnh</label></a></td>
                            <td><a href='incs.php?id_nd=<?php echo $row['ND_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>In chỉ số</label></a></td>
                            <td><a href='inst.php?id_nd=<?php echo $row['ND_ID'] ?>'><label class='badge badge-sm bg-gradient-warning'>In sổ tiêm</label></a></td>
                          </tr>
                        <?php
                        }
                      } else {
