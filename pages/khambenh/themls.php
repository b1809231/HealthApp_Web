            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm lịch sử khám bệnh</h6>
                    </div>
                </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_them = "INSERT INTO khambenh (ND_ID,KB_CHUANDOAN,KB_THUOCUONG,KB_NHACNHO,KB_NGAYKHAM) VALUES ('$nd','$cd','$tu','$nn','$nk') ";
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="chuandoan" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Thuốc uống</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="thuocuong" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Nhắc nhở</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="nhacnho" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ngày khám</label>
                            <div class="input-group input-group-outline">
                                <input type="date" name="ngaykham" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
