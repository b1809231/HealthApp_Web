            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm sổ tiêm người dùng</h6>
                    </div>
                </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_them = "INSERT INTO sotiem (ND_ID,ST_TENTHUOC,ST_TENMUI,ST_NGAYTIEM,ST_GHICHU) VALUES ('$nd','$tt','$tm','$ngay','$gc') ";
                    $query = mysqli_query($con, $sql_them);

                    $_SESSION['message'] = "Đã thêm";
                    header('location: sotiem.php');
                }
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="tenthuoc" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Tên mũi</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="tenmui" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="ghichu" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ngày tiêm</label>
                            <div class="input-group input-group-outline">
                                <input type="date" name="ngaytiem" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
