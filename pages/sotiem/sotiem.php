                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Sổ tiêm người dùng</h6>
                                </div>
                            </div>
                            <?php
                            //  message
                            ...
                            <div style="align-self:center ;">
                                <td><a href='themst.php'><button class='btn btn-dark'>Thêm</button></a></td>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thuốc tiêm</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mũi tiêm</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ngày tiêm</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM sotiem INNER JOIN nguoidung on sotiem.ND_ID=nguoidung.ND_ID";
                                            $query_run = mysqli_query($con, $query);
                                            if (mysqli_num_rows($query_run) > 0) {
                                                foreach ($query_run as $row) {
                                            ?>
                                                    <tr>                                                    
                                                        <td><a href='suast.php?id_st=<?php echo $row['ST_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Sửa</label></a></td>
                                                        <td><?php echo $row['ST_ID']; ?></td>
                                                        <td><?php echo $row['ND_HOVATEN']; ?></td>
                                                        <td><?php echo $row['ST_TENTHUOC']; ?></td>
                                                        <td><?php echo $row['ST_TENMUI']; ?></td>
                                                        <td><?php echo $row['ST_NGAYTIEM']; ?></td>
                                                        <td><?php echo $row['ST_GHICHU']; ?></td>
                                                    </tr>
                                                <?php
                                                }
                                            } else {
