            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Sửa sổ tiêm người dùng</h6>
                    </div>
                </div>
                <br>
                <?php               
                ...
                $sql_up = "SELECT * FROM sotiem join nguoidung  on sotiem.ND_ID=nguoidung.ND_ID where ST_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {                    
                    ...
                    $sql_sua="UPDATE `sotiem` SET `ND_ID`='$nd',`ST_TENTHUOC`='$tt',`ST_TENMUI`='$tm',`ST_NGAYTIEM`='$nt',`ST_GHICHU`='$gc' WHERE `ST_ID`='$id'";
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="tenthuoc" class="form-control" value="<?php echo $row_up['ST_TENTHUOC']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Tên mũi</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="tenmui" class="form-control" value="<?php echo $row_up['ST_TENMUI']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ghichu" class="form-control" value="<?php echo $row_up['ST_GHICHU']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ngày tiêm</label>
                            <div class="input-group input-group-outline">
                                <input type="date" name="ngaytiem" class="form-control" value="<?php echo $row_up['ST_NGAYTIEM']; ?>" required placeholder="">
                            </div>
                        </div>
