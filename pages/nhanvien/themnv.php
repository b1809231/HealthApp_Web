            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm nhân viên</h6>
                    </div>
                </div>
                <?php
              //  message
              ...
              ?>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if(strlen($sdt) != 10){
                        ...
                        $sql_them = "INSERT INTO nhanvien (NV_HINHANH,NV_HOTEN,NV_GIOITINH,NV_NGAYSINH,NV_DIACHI,NV_MAIL,NV_SDT,NV_MATKHAU,NV_TRANGTHAI,NV_QUYENSD) 
                        VALUES ('$a','$t','$gt','$day','$dc','$mail','$sdt','$mk',1,1) ";
                        $query = mysqli_query($con, $sql_them);
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="ten" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="date" name="ngaysinh" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Địa chỉ</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="diachi" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Mail</label>
                            <div class="input-group input-group-outline">
                                <input type="email" name="mail" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Số điện thoại</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="sodienthoai" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Mật khẩu</label>
                            <div class="input-group input-group-outline">
                                <input type="password" name="matkhau" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                </div>
                <br>
                <button type="submit" class="btn btn-primary btn-fw" name="submit">Thêm</button>
                </form>
            </div>
