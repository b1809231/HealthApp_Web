            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Nhân viên</h6>
                </div>
              </div>
              <?php
              //  message
              ...
              <td><a href='themnv.php'><button class='btn btn-dark'>Thêm</button></a></td>
              </div>
              <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT * FROM nhanvien WHERE NV_QUYENSD=1";
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <img style="width:50px; border-radius: 50%; height:50px;" src="../../image/nhanvien/<?php echo $row['NV_HINHANH']; ?>">                              
                            </td>
                            <td><?php echo $row['NV_HOTEN']; ?></td>
                            <td><?php echo $row['NV_DIACHI']; ?></td>
                            <td><?php echo $row['NV_MAIL']; ?></td>
                            <td><?php echo $row['NV_SDT']; ?></td>
                            <td>
                              <?php 
                              if($row['NV_TRANGTHAI'] == '0'){
                                echo 'Đang khóa';
                              }elseif($row['NV_TRANGTHAI'] == '1'){
                                echo 'Hoạt động';
                              }
                              ?>
                            </td>
                            <td><?php echo $row['created_at']; ?></td>
                            <td><a href='mokhoanv.php?id_nv=<?php echo $row['NV_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Mở khóa</label></a></td>
                            <td><a href='khoanv.php?id_nv=<?php echo $row['NV_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>Khóa</label></a></td>
                            <td><a href='suanv.php?id_nv=<?php echo $row['NV_ID'] ?>'><label class='badge badge-sm bg-gradient-warning'>Sửa</label></a></td>
                          </tr>
                        <?php
                        }
                      } else {
