    ...
    ?>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-4">
                ...
                $sql_up = "SELECT * FROM bantin where BT_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_sua = "UPDATE `bantin` SET `BT_ANH`='$a',`BT_CHUDE`='$cd',`BT_NOIDUNG`='$nd' WHERE BT_ID= $id";
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" name="anh" class="form-control-file" value="<?php echo $row_up['BT_ANH']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Chủ đề</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="chude" class="form-control" value="<?php echo $row_up['BT_CHUDE']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                ...
                                <textarea id="noidung" name="noidung" class="form-control" ><?php echo $row_up['BT_NOIDUNG']; ?></textarea>
                                <script>
