            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm bản tin</h6>
                    </div>
                </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_them = "INSERT INTO bantin (BT_ANH,BT_CHUDE,BT_NOIDUNG) VALUES ('$a','$cd','$nd') ";
                    $query = mysqli_query($con, $sql_them);
                    move_uploaded_file($a_tmp, '../../image/bantin/' . $a);
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="chude" class="form-control" id="exampleFormControlInput1" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Nội dung</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="noidung" class="form-control" id="exampleFormControlInput1" required placeholder=""></textarea>
                            </div>
                        </div>
