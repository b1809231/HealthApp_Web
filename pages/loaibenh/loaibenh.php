  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="loaibenh.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">category</i>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Loại bệnh</h6>
              </div>
            </div>
            <?php
              //  message
            ...
            <form action="themck.php"  method="POST">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item">Tên loại  &emsp;<input type="text" name="ck_ten"></li>
              ...
              <div class="table-responsive p-0">
                ...
                //
                $pageld = mysqli_query($con, "SELECT * FROM chuyenkhoa LIMIT $start,$limit ");
                ?>
                <tbody>
                  <?php 
                  foreach($pageld as $key => $value){
                    ...
                    <tr>
                      ...
                      <td><?php echo $value['CK_TEN'] ?></td>
                      <td><a href='suack.php?id_ck=<?php echo $value['CK_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Sửa</label></a></td>
                      <td><a href='xoack.php?id_ck=<?php echo $value['CK_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>Xóa</label></a></td>
                    </tr>
                  <?php } ?>                  
                </tbody>                  
          ...
          <ul class="pagination" style="display: flex;justify-content: center; padding: 10px 18px;  color: #222;    ">
                <li style="margin: 0 3px;"><a href="loaibenh.php?page=<?php echo $cr_page-1 ?>" style="color: black;   float: left;   padding: 8px 16px;   text-decoration: none;   transition: background-color .3s;">&laquo;</a></li>
                <?php
                for($i=1;$i<=$page; $i++){
                  ?>
                  <li style="margin: 0 3px;"><a href="loaibenh.php?page= <?php echo $i ?>" style="color: black;   float: left;   padding: 8px 16px;   text-decoration: none;   transition: background-color .3s;"><?php echo $i?> </a> </li> 
                  <?php }               
                ?>
