            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Sửa loại bệnh</h6>
                    </div>
                </div>
                <br>
                <?php               
                ...
                $sql_up = "SELECT * FROM chuyenkhoa where CK_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_sua="UPDATE `chuyenkhoa` SET `CK_TEN`='$t' WHERE CK_ID= $id";
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="ten" class="form-control" value="<?php echo $row_up['CK_TEN']; ?>" required placeholder="">
                            </div>
                        </div>
