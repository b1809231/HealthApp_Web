            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Thêm bệnh</h6>
                    </div>
                </div>

                <br>
                <?php
                $sql_ld = "SELECT *FROM chuyenkhoa";
                ...
                if (isset($_POST['submit'])) {                    
                    ...
                    $sql_them = "INSERT INTO benh (B_TENBENH,B_THONGTINTONGQUAT,B_GHICHU,CK_ID) VALUES ('$t','$ct','$gc','$ck') ";                    $query = mysqli_query($con, $sql_them);
                            ...
                            <div class="input-group input-group-outline">
                                <select class="form-control" name="loaithuoc">
                                    ...
                                    while ($row_ld = mysqli_fetch_assoc($query_ld)) { ?>
                                        <option value="<?php echo $row_ld['CK_ID']; ?>"><?php echo $row_ld['CK_TEN']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
