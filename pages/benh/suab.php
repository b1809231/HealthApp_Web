            ...
            <div class="container-fluid py-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">Sửa bệnh</h6>
                    </div>
                </div>
                <br>
                <?php               
                include '../../connectsql.php';
                $id = $_GET['id_b'];
                $sql_lb = "SELECT* FROM chuyenkhoa";
                $query_lb = mysqli_query($con, $sql_lb);

                $sql_up = "SELECT * FROM benh where B_ID= '$id'";
                ...
                if (isset($_POST['submit'])) {                    
                    ...
                    $sql_sua="UPDATE `benh` SET `CK_ID`='$lb',`B_TENBENH`='$t',`B_THONGTINTONGQUAT`='$ct',`B_GHICHU`='$gc' WHERE B_ID= $id";
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="ten" class="form-control" value="<?php echo $row_up['B_TENBENH']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Thông tin chi tiết</label>
                            <div class="input-group input-group-outline">
                                <textarea type="text" name="chitiet" class="form-control" value="<?php echo $row_up['B_THONGTINTONGQUAT']; ?>" required placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ghi chú</label>
                            <div class="input-group input-group-outline">
                                <input type="text" name="ghichu" class="form-control" value="<?php echo $row_up['B_GHICHU']; ?>" required placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Loại bệnh</label>
                            <div class="input-group input-group-outline">
                                <select class="form-control" name="loaibenh">

                                    <?php
                                    while ($row_lb = mysqli_fetch_assoc($query_lb)) { ?>
                                        <option value="<?php echo $row_lb['CK_ID']; ?>"><?php echo $row_lb['CK_TEN']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
