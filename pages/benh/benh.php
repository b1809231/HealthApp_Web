    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-white active bg-gradient-primary" href="benh.php">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3" style="text-align: center;">BỆNH</h6>
                </div>
              </div>
              <?php
              //  message
              ...
              <div style="align-self:center ;">
                <td><a href='themb.php'><button class='btn btn-dark'>Thêm</button></a></td>
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tên bệnh</th>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Thuộc chuyên khoa</th>
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT * FROM benh INNER JOIN chuyenkhoa on benh.CK_ID=chuyenkhoa.CK_ID";
                      $query_run = mysqli_query($con, $query);
                      if (mysqli_num_rows($query_run) > 0) {
                        foreach ($query_run as $row) {
                      ?>
                          <tr>
                            <td><a href='suab.php?id_b=<?php echo $row['B_ID'] ?>'><label class='badge badge-sm bg-gradient-success'>Sửa</label></a></td>
                            <td><a onclick="return Del('<?php echo $row['B_TENBENH']; ?>')" href='xoab.php?id_b=<?php echo $row['B_ID'] ?>'><label class='badge badge-sm bg-gradient-secondary'>Xóa</label></a></td>
                            <td><?php echo $row['B_ID']; ?></td>                            
                            <td><?php echo $row['B_TENBENH']; ?></td>
                            <td><?php echo $row['B_THONGTINTONGQUAT']; ?></td>
                            <td><?php echo $row['B_GHICHU']; ?></td>
                            <td><?php echo $row['CK_TEN']; ?></td>
